...
//        }
    ...
    public void createNewBullet(){
        Bullet bullet = new Bullet(new Sprite(new Texture("img/bullet.png")), 6, player ,2 ,(TiledMapTileLayer) map.getLayers().get(0));
        bullets.add(bullet);
    }
...
//
//        renderer.render();
//        player.setX(player.getX() + touchpad.getTouchpad().getKnobPercentX()*blockSpeed);
//        player.setY(player.getY() + touchpad.getTouchpad().getKnobPercentY()*blockSpeed);
//        if(Gdx.input.isKeyPressed(Input.Keys.W)){
//            player.getSprite().setY(player.getY()+5f);
//
//        }
////        batch.begin();
////        player.draw(batch);
